    ...
    return (
        <div className="channel-item">
            ...
            <div className="channel-info">
                ...
                <Link className="dashboard-link" to={props.isMember ? `/chat/${props.uid}` : ""} ><button disabled={!props.isMember} className="to-dashboard dashboard-button">{props.isMember ? !props.moderator ? "Go To Chat" : "Go To ModView" : <>This channel doesn't use DisStreamChat</>}</button></Link>
            </div>
        </div>
    )
}
